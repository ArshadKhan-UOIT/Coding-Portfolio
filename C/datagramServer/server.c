...
int main(int argc, char **argv) {
	 ...
	 */
	while(1) {
		// rc = recvfrom(sock, buffer, 512, 0, (struct sockaddr*) &address, &addrLength);
		// sendto(sock, buffer, rc, 0, (const struct sockaddr*) &address, addrLength);
		rc = recvfrom(sock, (char *) &arg1, sizeof(arg1), 0, (struct sockaddr*) &address, &addrLength);
		rc = recvfrom(sock, (char *) &arg2, sizeof(arg2), 0, (struct sockaddr*) &address, &addrLength);
		result = (arg1 + arg2);
		sendto(sock, (char *) &result, sizeof(result), 0, (const struct sockaddr*) &address, addrLength);
	}
